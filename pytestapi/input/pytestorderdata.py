...
class final():
    json_csv.order_data1("Customers.csv")
    json_csv.order_data2("Customer Address.csv")
    json_csv.order_data3("customer order master.csv")
    json_csv.order_data4("customer order details.csv")
    json_csv.order_data5("payment details.csv")
